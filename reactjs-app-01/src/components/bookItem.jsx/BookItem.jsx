  ...
  return (
    <>
        <div className="flex flex-col items-center min-w-48 shadow-lg min-h-60 w-40">
            ...
            {
                !itemCount?<img  className='bg-white w-6 my-3' onClick={()=>setItemCount(prev=>prev+1)} src= {assets.add} />:
                <div className='flex justify-center items-center my-3'>
                    <img src={assets.minus} className='w-6 mx-3' onClick={()=>setItemCount(prev=>prev-1)} alt="" />
                    <p>{itemCount}</p>
                    <img src={assets.plus} className='w-5 mx-3' onClick={()=>setItemCount(prev =>prev+1)} alt="" />
                </div>
            }
